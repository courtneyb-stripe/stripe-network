...
export default function GlobalHeader() {
  return (
    <header
      className="flex w-full items-center justify-between bg-surface pl-10 pr-0 py-3"
    ...
    >
      ...
      {/* [desktop +] — 24px between dock and icon group; icon group: 16px icons, 24px gap; 40px padding right */}
      <div
        className="flex items-center justify-end shrink-0 pr-10"
        data-name="[desktop +]"
        data-node-id="2:370"
      >
        <AppDock />
