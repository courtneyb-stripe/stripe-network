...
export function SimpleMetricCardSkeleton({ className = '' }: { className?: string }) {
  return (
    <div
      className={`flex min-w-0 flex-col rounded-[12px] border border-neutral-50 bg-surface justify-center gap-1.5 py-[8px] px-[12px] shadow-[0px_1px_2px_-0.5px_rgba(0,0,0,0.05)] ${SIMPLE_METRIC_CARD_MIN_HEIGHT} ${className}`.trim()}
