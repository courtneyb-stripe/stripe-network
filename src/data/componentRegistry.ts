...
export const COMPONENT_REGISTRY: ComponentEntry[] = [
  ...
  },
  {
    ...
    description: 'baby/card/subscription (Figma 6269:117912). Dense badges, plan title, frequency / next invoice (dotted link) / service period. Carousel + grid.',
    status: 'in_progress',
    source: 'borrowed',
    borrowedSourceLabel: 'Account hub',
  },
