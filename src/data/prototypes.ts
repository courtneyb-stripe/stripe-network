...
const PROTOTYPES_ALL: PrototypeRow[] = [
  ...
  },
  {
    ...
    description: 'Header explorations — merged to main; branch preview retained',
  ...
  },
  {
    ...
    status: 'Complete',
    lastUpdated: 'May 20, 2026',
    url: 'https://stripe-network-midnkg82u.vercelapp.stripe.dev/capability-explorer',
  },
  {
    id: 'uad-composition-model',
    category: 'working',
    name: 'UAD composition model',
    description: 'Composition model for unified account detail',
    branch: 'uad-composition-model',
    owner: '@courtneyb',
    status: 'In progress',
    lastUpdated: 'May 20, 2026',
